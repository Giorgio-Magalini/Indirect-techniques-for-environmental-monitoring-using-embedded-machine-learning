 ...
 * @return  void
 */
MYHPMA115S0::MYHPMA115S0(Stream& serial):
  _serial(serial)
{
 ...
 * @return  void
 */
void MYHPMA115S0::SendCmd(unsigned char * cmdBuf, unsigned int cmdSize) {
  //Clear RX
 ...
 */
int MYHPMA115S0::ReadCmdResp(unsigned char * dataBuf, unsigned int dataBufSize, unsigned int cmdType) {
 ...
 */
boolean MYHPMA115S0::ReadParticleMeasurement(unsigned int * pm2_5, unsigned int * pm10) {
 ...
 * @return  void
 */
void MYHPMA115S0::StartParticleMeasurement() {
 ...
 * @return  void
 */
void MYHPMA115S0::StopParticleMeasurement() {
 ...
 * @return  void
 */
void MYHPMA115S0::EnableAutoSend() {
 ...
 * @return  void
 */
void MYHPMA115S0::DisableAutoSend() {
...
*/
unsigned int MYHPMA115S0::GetPM2_5() {
  return _pm2_5;
}
...
*/
unsigned int MYHPMA115S0::GetPM10() {
  return _pm10;
}
